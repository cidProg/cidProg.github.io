...
namespace HelloWorldApp
{
    ...
    class Datenbank : Db
    {
        ...
        //-------
        public void DB_loeschen(string table, string columnName, int IDNumber, SqlConnection connection)
        {
        ...
        public void DB_search(string table, string sucheInSpalte, string sucheNach, SqlConnection connection)
        {
